(self["webpackChunklaravel_react"] = self["webpackChunklaravel_react"] || []).push([["resources_js_modules_article_pages_edit_index_js"],{
...
var Page = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Page, [{
    ...
    value: function loadArticle() {
      ...
      if (!article.id) {
        dispatch((0,_service__WEBPACK_IMPORTED_MODULE_3__.articleEditRequest)(match.params.id));
      }
    }
  }, {
    key: "handleChange",
    ...
    value: function submit(article) {
      ...
      this.props.dispatch((0,_service__WEBPACK_IMPORTED_MODULE_3__.articleUpdateRequest)(article))["catch"](function (_ref) {
    ...
    value: function renderForm() {
      ...
      if (article.id) {
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_components_Form__WEBPACK_IMPORTED_MODULE_5__.default, _objectSpread(_objectSpread({}, this.state), {}, {
...
_defineProperty(Page, "propTypes", {
  match: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().object.isRequired),
  article: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().object),
...
//# sourceMappingURL=resources_js_modules_article_pages_edit_index_js.js.map